...
<div>	
		...
		<div id="superior">
			...
			<table style="width:100%" border="1">
				...
				<tr>
					<td colspan="3" align="center"><h4 style="margin: 0">SMART GARBAGE MONITORING SYSTEM USING IOT </h4></td></tr>
...

	{
...

			{
				...
				marker=new google.maps.Marker({
					  ...
					  position:new google.maps.LatLng(obj.lat,obj.lon),icon: 'http://iotvehicle.co.in/iot_waste_dustbin/images/garbage.png',title: "text "+obj.gid,animation: google.maps.Animation.DROP,
					  });
